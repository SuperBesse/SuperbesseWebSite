...
/** @type {string} */
const CACHE_VERSION = '1739226683|2928643472';
/** @type {string} */
const CACHE_PREFIX = 'TutoPong-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'TutoPong.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["TutoPong.html","TutoPong.js","TutoPong.offline.html","TutoPong.icon.png","TutoPong.apple-touch-icon.png","TutoPong.worker.js","TutoPong.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["TutoPong.wasm","TutoPong.pck"];
